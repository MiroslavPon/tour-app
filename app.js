...
function loadTours() {
  ...
  // при первом лоаде кладем тестовые экскурсии в хранилище один раз
...
function openTour(tour) {
  ...
  document.getElementById("detailHeroImg").src = img;
  document.getElementById("detailHeroImg").alt = tour.title;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("toContactBtn").addEventListener("click", () => {
    bookingState.people = Math.max(1, Number(document.getElementById("peopleInput").value) || 1);
    showStep("contact");
  });
